...
class cls_conexion1
{
    ...
    private $user = "csxmcpji_4meses";
    private $password = "nJ+ZbE^{?8fR";
    private $database1 = "csxmcpji_db_ads";
    private $database="";
    private $_numPagina;
...
function elimina_especiales_textarea($cadena,$mayus_minus){
 ...
 $cadena = str_replace($find, $repl, $cadena);
	...
	$cadena = str_replace("width: 527px;", "", $cadena); //cuando copian y pegan mensaje de vanuncios hay que eliminar este width
