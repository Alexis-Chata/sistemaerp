...
//        var codigosProductos = [];
        $('#txtNumeroBoleta').focus();
        
        $('#txtNumeroBoleta').change(function(){
//            //verificar
//            verificaNumero();
            console.log("Boleta");
            var numero = $('#txtNumeroBoleta').val();
            var ruta = "/movimiento/buscaNumeroBoleta/"+ numero;
	...
	$('#btnRegistrar').click(function(e){
            ...
            $.post(ruta, function(data){
                if(data!=0){
                    ...
                    if (!confirm('¿ ESTÁ SEGURO DE REGISTRAR LA BOLETA?')){
                    }else{
