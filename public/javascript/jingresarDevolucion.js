...
//        var codigosProductos = [];
        $('#txtNumeroDevolucion').focus();
        
        $('#txtNumeroDevolucion').change(function(){
//            //verificar
//            verificaNumero();
            console.log("Devoluciones");
            var numero = $('#txtNumeroDevolucion').val();
            var ruta = "/movimiento/buscaNumeroDevolucion/"+ numero;
	...
	$('#btnRegistrar').click(function(e){
            ...
            $.post(ruta, function(data){
                if(data!=0){
                    ...
                    if (!confirm('¿ ESTÁ SEGURO DE REGISTRAR LA DEVOLUCION?')){
                    }else{
