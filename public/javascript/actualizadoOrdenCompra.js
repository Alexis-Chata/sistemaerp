$(document).ready(function () {
    ...
    $('#txtOrdenCompra').autocomplete({
        source: "/ordencompra/autoCompleteCompraXDua/",
    ...
    $('#tblDetalleOrdenCompra').on('blur', '.txtCantidadDetalle, .txtVolumen, .txtfobDetalle', function () {
    ...
    $('#tblDetalleOrdenCompra').on('blur', '.txtAdvaloremPDetalle', function () {
        item = $(this).parents('tr');
        advaloremp = $(this).val();
    ...
    $('#tblDetalleOrdenCompra').on('blur', '.txtAdvaloremVDetalle', function () {
    ...
    $('#btnExcel').click(function (e) {
        ...
        window.location = "/importaciones/exportarordencompra/" + id;
    });
...
function anadirDetalledeOC(idordencompra) {
    $.ajax({
        url: '/ordencompra/listardetalleXoc',
        type: 'post',
        datatype: 'json',
...
function recalcular(element) {
    ...
    console.log('NUEVO CBM: ' + nuevoCBM);
...
function calcularConceptos() {
    ...
    calcularParteConceptos(('.txtfobTotalDetalle'), ('.txtCV3Detalle'), $('#txtTotalcostocv3OC').val());
    calcularParteConceptos(('.txtfobTotalDetalle'), ('.txtAgenteAduanaDetalle'), $('#txtTotalcomisionagenteaduOC').val());
    calcularParteConceptos(('.txtVolumenDetalle'), ('.txtFleteInternoDetalle'), $('#txtTotalcostofleteinternoOC').val());
}