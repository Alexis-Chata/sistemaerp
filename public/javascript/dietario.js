		...
		if (banderapagar == 1) {
                    if (confirm("¿Esta Seguro de Pagar la Letra?")) {
                            $.ajax({
                                    ...
                                    type:'post',
                                    dataType:'html',
                                    data:{'idordenventa':idordenventa.val(),'idcliente':idcliente.val(),'idcobrador':idcobradoraenviar,'monto':monto,'formacobro':formacobro,'iddetalleordencobro':iddetalleordencobro,'numeroletra':numeroletra,'numerorecibo':$('#numeroRecibo').val(),'fechapago':$('#fechaPago').val(),'observacionesrecibo':$('#idobservacionrecibo').val()},
                                    success:function(resp){
                                            console.log(resp);
