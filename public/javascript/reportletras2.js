...
function Mostrarplanilla(numeroLetra) {
    ...
    $.post('/reporte/crearplanilla/', {numeroLetra: numeroLetra}, function (data) {
        ...
        $('#planilla tbody').append("<tr>" +
                "<td>" + data.nombrecli + " " + data.apellido1 + " " + data.apellido2 + "<input type='hidden' name='letra[" + contador + "][nombres]' value='" + data.nombrecli + " " + data.apellido1 + " " + data.apellido2 + "'>" + "</td>" +
                "<td>" + data.rucx + "<input type='hidden' name='letra[" + contador + "][ruc]' value='" + data.rucx + "'>" + "</td>" +
                "<td>" + data.monedita + "<input type='hidden' name='letra[" + contador + "][moneda]' value='" + data.monedita + "'>" + "</td>" +
                "<td>" + data.numeroletra + "<input type='hidden' name='letra[" + contador + "][nombreletra]' value='" + data.numeroletra + "'>" + "</td>" +
                "<td>" + data.diaHoy + "<input type='hidden' name='letra[" + contador + "][diaHoy]' value='" + data.diaHoy + "'>" + "</td>" +
                "<td>" + data.fvencimiento2 + "<input type='hidden' name='letra[" + contador + "][fvencimiento]' value='" + data.fvencimiento2 + "'>" + "</td>" +
                "<td>" + data.importedoc + "<input type='hidden' name='letra[" + contador + "][importedoc]' value='" + data.importedoc + "'>" + "</td>" +
                "<td>" + data.plaza + "<input type='hidden' name='letra[" + contador + "][plaza]' value='" + data.plaza + "'>" + "</td>" +
