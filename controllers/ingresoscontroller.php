...
//	}
    ...
    function IngresosxOrdenventa() {
        ...
        for ($i = 0; $i < $cantidad; $i++) {
            ...
            $fila .= "<td>" . ($dataIngresos[$i]['montoasignado'] == 0 ? ($dataIngresos[$i]['montoliberado'] > 0 ? '' : '<button class="anularLetra c2_datashet" data-id="' . $dataIngresos[$i]['idingresos'] . '">Anular</button>') : '') . "</td>";
            $fila .= "</tr>";
        }
        echo $fila;
        echo "<tr><td colspan='12'>&nbsp;</td></tr>";
